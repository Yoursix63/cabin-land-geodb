-- VA county augmentation support: sale price/date columns (several VA
-- county GIS services publish them — WV's public extract doesn't),
-- exposed through parcel_scores.
...
c AS (
    SELECT
        ...
        CASE
            ...
            WHEN pm.nbr_dist_m IS NULL      THEN 100
            ELSE GREATEST(0,
